...
public class AboutDialogText extends DialogFragment {
    public static void showAbout(android.support.v4.app.FragmentManager fm) {
        ...
        new AboutDialogText().show(ft, "dialog_about");
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextView view = (TextView) inflater.inflate(R.layout.fragment_about_dialog_text, null);
